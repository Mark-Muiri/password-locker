...
class TestCredentials(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_user_list = Credentials('Twitter', 'Mark', 'Muiri','Muirimark','12345')
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_user_list.first_name,"Mark")
        self.assertEqual(self.new_user_list.last_name,"Muiri")
        self.assertEqual(self.new_user_list.username,"Muirimark")
